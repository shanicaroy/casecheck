...
const baseAnswer: Classification = {
  ...
  seniority: "unclear",
  case_type: [],
  inventory: { problem: inventoryMissing, research: inventoryMissing, decisions: inventoryMissing, iteration: inventoryMissing, outcome: inventoryMissing, learnings: inventoryMissing },
